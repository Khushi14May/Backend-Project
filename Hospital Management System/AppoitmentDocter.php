...
<body>
    ...
    <div class="container-fluid">
      ...
      <ul class="nav nav-pills">
        ...
        <li class="nav-item">
          <a class="nav-link text-light" href="#" onclick="d('docter')">Delete Appoitments</a>
        </li>
        </ul>
        <?php session_start();
 ...
 <div class="col-md-6 patient">
  ...
  <div class="col-md-6 docter" style="display:none">
    <table class="table table-hover table-bordered " style="width: 500px; margin: 15% 50%; border: 2px;">

      <tr class="bg-primary">
        <td scope="col" colspan="3" style="text-align: center;">Delete Appoitments</td>
      </tr>
      <tr>
            <th>Name</th>
            <th>Symptoms</th>
    ...
    <?php
        ...
        <td><?php echo $result['Name'];?></td>
        <td><?php echo $result['Symptoms'];?></td>
        <td><a href="ApproveDoctAppo.php?Name=<?php echo $result['Name'];?>" data-toogle="tooltip" data-placement="bottom" title="delete"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
    </tr>
    <?php
        }
       ?>
