...
if(isset($_POST['Update'])){ 
    ...
    $sql="UPDATE `docter_records` SET `DocId`='$id1',`Name`='$name1',`Mobile`='$number',`Address`='$Address',`Department`='$department' WHERE `DocId`='$id' ";
...
<section class="book" id="book">
    ...
    <div class="row">
        ...
        <form action="" method="post">
            <h3>Update Docter</h3>
            <input type="text" placeholder="your id" class="box" name="id" value="<?php echo "$id";?>">
            <input type="text" placeholder="your name" class="box" name="name" value="<?php echo "$name";?>">
            <input type="number" placeholder="your number" class="box" name="number" value="<?php echo "$num";?>">
            <input type="text" placeholder="your department" class="box" name="department" value="<?php echo "$dep";?>">
